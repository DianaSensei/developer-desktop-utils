            ...
            <ToolSection>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  aria-pressed={showPw}
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 rounded text-fg-mute hover:text-fg focus-visible:outline-hidden focus-visible:ring-[3px] focus-visible:ring-focus"
                >
