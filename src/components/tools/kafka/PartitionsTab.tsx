...
export function PartitionsTab({ partitions }: PartitionsTabProps) {
  if (partitions.length === 0) {
    return <div className="px-4 py-8 text-sm text-fg-mute text-center">No partition data</div>;
  }

  return (
    <div className="overflow-x-auto">
      <div className="grid grid-cols-[auto_1fr_1fr_1fr] gap-x-6 px-4 py-2 text-xs font-medium text-fg-mute border-b bg-muted/20 sticky top-0">
        <span>Partition</span>
      ...
      {partitions.map((p) => {
        ...
        return (
          ...
          >
            ...
            <span className="text-right tabular-nums font-mono text-xs text-fg-mute">
