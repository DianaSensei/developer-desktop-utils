...
import { containerApi, type ContainerConnection, type ContainerDetails, type ContainerSummary } from './types';
...
export function ContainerDetailsDialog({ open, onOpenChange, connection, container }: {
  open: boolean;
