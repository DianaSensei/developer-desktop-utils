...
describe('scriptCompletion shape parity', () => {
  it('bru', () => {
    const real = pathsOf(makeBru({ runtime: {}, collectionVar: {}, collectionEnv: {}, globalEnv: {}, collectionEnvName: null, globalEnvName: null }));
  ...
  it('pm', () => {
    const bru = makeBru({ runtime: {}, collectionVar: {}, collectionEnv: {}, globalEnv: {}, collectionEnvName: null, globalEnvName: null });
