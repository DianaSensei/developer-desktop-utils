          ...
          {days.map((d) => {
            ...
            return (
              ...
              >
                ...
                {Array.from({ length: 24 }, (_, h) => (
                  <div key={h}>
                    <div className="absolute left-0 right-0 border-t border-line" style={{ top: h * HOUR_PX }} />
                    <div className="absolute left-0 right-0 border-t border-line-soft" style={{ top: h * HOUR_PX + HOUR_PX / 2 }} />
                  </div>
                ))}
