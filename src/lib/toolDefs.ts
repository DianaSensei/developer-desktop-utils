...
export const TOOL_DEFS: ToolDef[] = [
  ...
  },
  {
    ...
    description: 'Convert case, sort, trim, reverse, and transform text in bulk.',
  },
  {
  ...
  },
  {
    ...
    description: 'Encode and decode Base64, URL, HTML entities, Hex, Morse, and more.',
  },
  {
    id: 'hash', label: 'Hash & Encrypt', icon: Hash,
    description: 'Compute MD5, SHA-1, SHA-256, SHA-512 hashes and AES encrypt/decrypt.',
  },
  {
    id: 'unix-time', label: 'Date / Time', icon: Clock,
    description: 'Convert timestamps, compare dates, and format in any timezone.',
  },
  {
  ...
  },
  {
    ...
    description: 'Decode and inspect JWT headers and payloads without verification.',
  },
  {
  ...
  {
    id: 'deduplicate', label: 'Deduplicate', icon: Filter,
    description: 'Remove duplicate lines or items from any list.',
  },
  {
    id: 'checksum', label: 'Checksum', icon: FileCheck,
    description: 'Compute MD5, SHA-1, SHA-256, and SHA-512 checksums for any file.',
  },
  {
    id: 'image-base64', label: 'Image ↔ Base64', icon: ImageIcon,
    description: 'Convert images to Base64 strings and render Base64 back to images.',
  },
  {
