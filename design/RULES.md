...
| **Màu Tailwind thô** (`text-green-500`, `bg-red-50`…) | Không theo được theme, không đổi được tone. Dùng token. |
| **Chữ dưới 11px** | Repo hiện có 379 chỗ vi phạm, xuống tới 8px. Không đọc được ở HiDPI. |
